...
public class Q12 {
    ...
    /*
    12. Faça uma ÚNICA função que, recebendo como parâmetro dois números inteiros, resulta verdadeiro, caso o primeiro seja maior ou igual ao segundo, ou falso, caso contrário.
    ...
    public static void main(String[] args) {
        ...
        for (int i = -10; i < 10; i++) {
            for (int j = -10; j < 10; j++) {
                System.out.println(i + " ≥ " + j + " = " + isMaiorOuIgual(i, j));
            }
        }
    }

    public static boolean isMaiorOuIgual(int a, int b) {
        if (a == b) return true;
        if (isMenor(a, b)) return false;
        return isMaiorOuIgual(--a, b);
    }
}
