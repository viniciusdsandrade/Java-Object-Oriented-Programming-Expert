    ...
    public static void main(String[] args) {
        try (Scanner input = new Scanner(System.in)) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                System.out.println("Imposto bruto total: " + TaxPayer.formatDecimal(taxPayers[i].getGrossTax()));
                System.out.println("Abatimento: " + TaxPayer.formatDecimal(taxPayers[i].getTaxRebate()));
                System.out.println("Imposto devido: " + TaxPayer.formatDecimal(taxPayers[i].getNetTax()));
                System.out.println();
            }
        } catch (Exception e) {
